  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
       If you have any question so you can ask them here we will make sure to answer them
      </p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <button className="flex mx-auto text-white bg-purple-600 border-0 py-2 px-8 focus:outline-none hover:bg-purple-800 rounded text-lg">
            Send
          </button>
        </div>
