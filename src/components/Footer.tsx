...
export default function Footer() {
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-gray-600  hover:text-blue-600">Blogs</a>
          </li>
          <li>
            <a className="text-gray-600  hover:text-blue-600">Podcasts</a>
          </li>
          <li>
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div className="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            ...
            <input
              ...
              id="footer-field"
              name="footer-field"
              className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-purple-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
            />
          </div>
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-purple-600 border-0 py-2 px-6 focus:outline-none hover:bg-purple-800 rounded">
           Search
          </button>
        </div>
  ...
  <div className="bg-gray-100">
    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <Image src="/images/logo.png " alt="logo" width={50} height={50} className='rounded-full'></Image>

        <span className="ml-3 text-xl">Shinning Star</span>
      </a>
